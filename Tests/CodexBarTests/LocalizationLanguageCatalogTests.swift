...
struct LocalizationLanguageCatalogTests {
    ...
    func `italian localization matches English catalog and includes current UI labels`() throws {
        ...
        let intentionallyUnchanged: Set = [
            "Account",
            "Available 5h/7d usage from your Claude Code statusLine configuration.",
            "Build",
            "Chrome",
            "Claude Code already has a custom statusLine. Use the manual composition guide.",
            "Claude Code settings are malformed; CodexBar will not overwrite them.",
            "Claude Code settings use a symbolic link; CodexBar will not write them.",
            "CodexBar statusLine command installed.",
            "CodexBar statusLine command removed.",
            "CodexBarCLI was not found in the installed app bundle.",
            "Cookie: ...",
            "Cookie: …",
            "Deployment",
            "Detailed Claude limits are unavailable while Keychain access is disabled.",
            "Email",
            "Endpoint",
            "File",
            "Gemini Flash",
            "GitHub",
            "Google OAuth",
            "Managed statusLine command is installed.",
            "Managed statusLine command is not installed.",
            "Managed statusLine command points to another CodexBar app. Repair it.",
            ...
            "Provider",
            "Repair",
            "The statusLine integration could not be updated.",
            "Token",
            "Uninstall",
            "Use your Claude Code statusLine feed",
            "%@ %@",
            "%@: %@",
            "byte_unit_byte",
            "byte_unit_gigabyte",
